...
const file_proto_user_v1_user_proto_rawDesc = "" +
	"\n" +
	"\x18proto/user/v1/user.proto\x12\auser.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xed\x02\n" +
	"\x04User\x12\x1f\n" +
...
var file_proto_user_v1_user_proto_depIdxs = []int32{
	15, // 0: user.v1.User.last_login_at:type_name -> google.protobuf.Timestamp
