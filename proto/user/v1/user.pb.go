...
type User struct {
	...
	LoginedAt     *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=logined_at,json=loginedAt,proto3" json:"logined_at,omitempty"`
...
const file_proto_user_v1_user_proto_rawDesc = "" +
	...
	"\n" +
	"logined_at\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\tloginedAt\x129\n" +
	"\n" +
